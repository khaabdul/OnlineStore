...
<body>
	<div class="container">
		...
		<form action="coup" method="POST">
			...
			<div class="form-group">
				<label for="price">Discount:</label> <input type="text"
					class="form-control" id="discount" name="discount" required>
			</div>
			<div class="form-group">
				<label for="brand">Date:</label> <input type="text"
					class="form-control" id="date" name="date" required>
			</div>
			<button type="submit" class="btn btn-primary" name="btn" value="add">Stubmit</button>
		</form>
	</div>
